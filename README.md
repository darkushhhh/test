...
**Используемые инструменты и их функционал:**
- **Nmap**: Сканирование сети и портов для обнаружения активных хостов, открытых портов и запущенных сервисов.
- **Nikto**: Сканирование веб-серверов для выявления уязвимостей, конфигурационных ошибок и потенциально опасных файлов.
- **Gobuster**: Перечисление скрытых директорий, файлов и поддоменов веб-сервера.
- **FFUF**: Быстрое сканирование веб-ресурсов для обнаружения скрытых файлов, директорий и параметров.
- **ZAP (OWASP ZAP)**: Автоматизированное тестирование веб-приложений на наличие уязвимостей.

---

### Пункт 5: Сканирование с использованием Nmap
